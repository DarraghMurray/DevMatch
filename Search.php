<html>
	...
	<?php
        if(isset($_REQUEST['search'])) {
			...
			// Extraction of relevant data from the request
			...
			} else {$searchCreationDate=0; $searchCompareDate=1;}		//If there is no date, consider it is the earliest date possible and we ask for later
			
			//Generation and execution of sql request, mutually exclusive (there can only be one type, and requests and display are tailor made for each type
            if($searchType === 0) {
