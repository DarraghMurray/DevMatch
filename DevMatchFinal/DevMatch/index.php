		...
		<div id="about">
			...
			<iframe class="resp-iframe"  src="https://www.youtube.com/embed/pLFMs96Y-e4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<div class="resp-about">
					<p>
					<h2>About DevMatch</h2><br>
					DevMatch is a platform for individuals and organisations in the games development industry. The main purpose of DevMatch is to facilitate the employment process and allow for teams to be created with ease.
					<br><br>Our platform allows developers to put themselves out there by presenting their skills and interests, in the hopes of connecting with other developers and organisations.</p>
				</div>
			</div>	
		</div>
