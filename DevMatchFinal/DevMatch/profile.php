		  ...
		  if(isset($_POST['cancel'])) {
		   ...
		   <div class="card h-100">
			  ...
			  echo'
				...
				echo '
					<a href="add-team.php"> <button type="button" id="addTeam" name="addTeam" class="btn btn-primary teamBtn">Add a team</button></a>
					<a href="edit-teams.php"> <button type="button" id="editTeams" name="editTeams" class="btn btn-primary teamBtn" style="margin-top:10px">Edit Teams</button></a>
					<a href="delete-teams.php"> <button type="button" id="deleteTeams" name="deleteTeams" class="btn btn-primary teamBtn" style="margin-top:10px">Delete Teams</button></a>
